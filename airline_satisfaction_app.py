...
page = st.sidebar.radio(
    "Choose a page:",
    ["Predict Satisfaction", "EDA Visualizations"]
)

if page == "Predict Satisfaction":
...
# New visuals page
    ...
    st.image(Image.open("heatmap.png"), caption="Correlation Heatmap")

    st.subheader("Satisfaction Rate by Gender")
    st.image(Image.open("satisfaction_by_gender.png"), caption="Satisfaction Rate by Gender")

    st.subheader("Satisfaction Rate by Class")
    st.image(Image.open("satisfaction_by_class.png"), caption="Satisfaction Rate by Class")

    st.subheader("Satisfaction Rate by Customer Type")
    st.image(Image.open("satisfaction_by_customer_type.png"), caption="Satisfaction Rate by Customer Type")

    st.subheader("Satisfaction Rate by Type of Travel")
    st.image(Image.open("satisfaction_by_travel_type.png"), caption="Satisfaction Rate by Type of Travel")
